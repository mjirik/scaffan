...
params = [
    {"name": "Input file", "type":"group", "children": [
...
def select_file():
    ...
    fn, mask = QtWidgets.QFileDialog.getOpenFileName(None, "Select Input File", directory=default_dir)
    print (fn)
    fnparam = p.param("Input file", "File name")
    fnparam.setValue(fn)
    # import pdb; pdb.set_trace()
    # print("ahoj")
p.param('Input file', 'Select').sigActivated.connect(select_file)
