...
python /storage/plzen1/home/$LOGNAME/projects/scaffan/experiments/lobulus_analysis.py > results.out
...
cp results.out $DATADIR && cp -r test_run_lobuluses_output_dir* $DATADIR || export CLEAN_SCRATCH=false
