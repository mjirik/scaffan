...
def insert_zeiss_annotation_rectangle(anim, listOfRectangles, pixelSizeMM):
    if (len(listOfRectangles) != 0):  
        ...
        for rectangle in listOfRectangles:
            ...
            x_param_rec = (x_top_left, x_top_right, x_down_left, x_down_right, x_top_left)
            ...
            y_param_rec = (y_top_left, y_top_right, y_down_left, y_down_right, y_top_left)
...
listOfBeziers, listOfCircles, listOfRectangles, listOfEllipses = load_zeiss_elements(anim, metadata, pixelSizeMM)
